...
public class LoggingAspect {
	...
	@Before("execution(* com.lej.mybatis.service.*.*(..))")
	public void logBefore(JoinPoint jp) {
		log.info("##### 메서드 실행전: {} #####Before#####", jp.getSignature());
	}

//	@AfterThrowing(pointcut = "execution(* com.lej.mybatis.service.*.*(..))", throwing = "excep")
//	public void logError(JoinPoint jp, Exception excep) {
//		log.info("##### 메서드\n 예외: {}, \n오류: {} #####end#####", jp.getSignature(), excep.getMessage());
//	}

	@AfterReturning(pointcut = "execution(* com.lej.mybatis.service.*.*(..))", returning = "result")
